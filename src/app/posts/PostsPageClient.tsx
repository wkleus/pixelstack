...
import BlogIconRain from '@/app/components/Posts/BlogIconRain'
...
const PostsPageClient = ({ posts }: PostsPageClientProps) => {
  ...
  return (
    <div className="relative overflow-hidden">
      {/* Decorative background: blog icons drifting down behind the content */}
      <BlogIconRain />

      <div className="relative z-10 mx-10 max-w-7xl py-28 sm:mx-25 2xl:mx-auto">
        <motion.h1
